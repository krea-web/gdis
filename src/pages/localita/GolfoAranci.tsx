...
const GolfoAranciPage = () => (
  <>
    ...
    <LocalitaHeroV2
      ...
      vehicleImage="https://zgazhrzjgefvjxknyffy.supabase.co/storage/v1/object/public/vehicles/FIAT%20PANDA.jpeg"
    ...
    >
      <div className="flex flex-wrap gap-3">
        <span className="px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-semibold">Consegna al traghetto</span>
    ...
    <MasonrySpots
      name="Golfo Aranci"
      spots={[
        { name: "Cala Moresca", desc: "Piccola baia protetta con acque cristalline. Paradiso per lo snorkeling.", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80" },
        { name: "Spiaggia Bianca", desc: "La spiaggia principale: sabbia bianchissima e servizi completi.", image: "https://images.unsplash.com/photo-1500375592092-40eb2168fd21?auto=format&fit=crop&w=600&q=80" },
        { name: "Capo Figari", desc: "Riserva naturale con sentieri panoramici e la storica stazione radio di Marconi.", image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=600&q=80" },
        { name: "Delfini nel Golfo", desc: "Escursioni in barca per avvistare i delfini. Un'esperienza unica in Sardegna.", image: "https://images.unsplash.com/photo-1506929562872-bb421503ef21?auto=format&fit=crop&w=600&q=80" },
      ]}
    />
    ...
    <LocalitaTrafficTips
      name="Golfo Aranci"
      tips={[
        { icon: "parking", title: "Terminal Traghetti", text: "Il parcheggio vicino al porto si riempie durante gli sbarchi. Ritira la Panda e parti subito." },
        { icon: "traffic", title: "Sbarco Weekend", text: "Venerdì e domenica il traffico aumenta. Con la Panda prendi le vie laterali ed eviti la coda." },
        { icon: "ztl", title: "Lungomare", text: "Il lungomare è pedonale la sera in estate. Parcheggia nelle vie parallele — la Panda entra ovunque." },
    ...
    <LocalitaNightlife
      name="Golfo Aranci"
      locali={[
        { name: "Terza Spiaggia", type: "ristorante", desc: "Pesce con i piedi nella sabbia. Frittura di paranza leggendaria e aragosta alla griglia." },
        { name: "Il Vecchio Porto", type: "ristorante", desc: "Trattoria marinara autentica. Fregola con arselle da non perdere." },
        { name: "Bar del Porto", type: "aperitivo", desc: "L'aperitivo dei pescatori. Prosecco e ostriche guardando i traghetti." },
        { name: "Lido Blu", type: "lounge", desc: "Beach bar con musica al tramonto. Cocktail tropicali e piedi nell'acqua." },
        { name: "Capo Figari", type: "ristorante", desc: "Cucina di mare raffinata con terrazza panoramica sul golfo." },
      ]}
    />
    ...
    <LocalitaFAQ
      name="Golfo Aranci"
      faqs={[
        { q: "Consegnate la Panda direttamente al terminal traghetti?", a: "Sì! È il nostro servizio più richiesto a Golfo Aranci. Ti aspettiamo allo sbarco con il veicolo pronto. Comunicaci l'orario del traghetto e pensiamo a tutto." },
        { q: "Quanto costa il parcheggio vicino al porto?", a: "Circa €2/ora in estate. Con la Panda trovi facilmente posto nelle vie laterali gratuite. In scooter parcheggi gratis ovunque." },
        { q: "Posso esplorare la costa nord con la Fiat Panda?", a: "Assolutamente! Da Golfo Aranci raggiungi Porto Rotondo in 20 minuti e San Teodoro in 40. La Panda è perfetta per le strade costiere." },
        { q: "Noleggiate anche scooter e quad a Golfo Aranci?", a: "Certo! Honda SH per il centro e le spiagge, Yamaha Raptor per l'entroterra. Consegna VIP inclusa." },
      ]}
    />
